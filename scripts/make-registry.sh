...
docker tag quay.io/cilium/cilium:v1.12.6 ${REGISTRY_URL}/cilium/cilium:v1.12.6
docker push ${REGISTRY_URL}/cilium/cilium:v1.12.6

docker pull quay.io/cilium/operator-generic:v1.12.6
docker tag quay.io/cilium/operator-generic:v1.12.6 ${REGISTRY_URL}/cilium/operator-generic:v1.12.6
docker push ${REGISTRY_URL}/cilium/operator-generic:v1.12.6
...
docker tag quay.io/cilium/hubble-relay:v1.12.6 ${REGISTRY_URL}/cilium/hubble-relay:v1.12.6
docker push ${REGISTRY_URL}/cilium/hubble-relay:v1.12.6
