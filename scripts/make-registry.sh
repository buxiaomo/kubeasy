...
docker pull docker.io/flannel/flannel:v0.22.1
docker tag docker.io/flannel/flannel:v0.22.1 ${REGISTRY_URL}/flannel/flannel:v0.22.1
docker push ${REGISTRY_URL}/flannel/flannel:v0.22.1
...
docker tag quay.io/cilium/cilium:v1.14.0 ${REGISTRY_URL}/cilium/cilium:v1.14.0
docker push ${REGISTRY_URL}/cilium/cilium:v1.14.0

docker pull quay.io/cilium/operator-generic:v1.14.0
docker tag quay.io/cilium/operator-generic:v1.14.0 ${REGISTRY_URL}/cilium/operator-generic:v1.14.0
docker push ${REGISTRY_URL}/cilium/operator-generic:v1.14.0
...
docker pull quay.io/cilium/hubble-relay:v1.14.0
docker tag quay.io/cilium/hubble-relay:v1.14.0 ${REGISTRY_URL}/cilium/hubble-relay:v1.14.0
docker push ${REGISTRY_URL}/cilium/hubble-relay:v1.14.0
