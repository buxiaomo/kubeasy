...
docker tag docker.io/calico/cni:v3.26.3 ${REGISTRY_URL}/calico/cni:v3.26.3
docker push ${REGISTRY_URL}/calico/cni:v3.26.3

docker pull docker.io/calico/node:v3.26.3
docker tag docker.io/calico/node:v3.26.3 ${REGISTRY_URL}/calico/node:v3.26.3
docker push ${REGISTRY_URL}/calico/node:v3.26.3

docker pull docker.io/calico/kube-controllers:v3.26.3
docker tag docker.io/calico/kube-controllers:v3.26.3 ${REGISTRY_URL}/calico/kube-controllers:v3.26.3
docker push ${REGISTRY_URL}/calico/kube-controllers:v3.26.3
...
docker tag docker.io/flannel/flannel:v0.23.0 ${REGISTRY_URL}/flannel/flannel:v0.23.0
docker push ${REGISTRY_URL}/flannel/flannel:v0.23.0
...
docker tag quay.io/cilium/cilium:v1.14.4 ${REGISTRY_URL}/cilium/cilium:v1.14.4
docker push ${REGISTRY_URL}/cilium/cilium:v1.14.4

docker pull quay.io/cilium/operator-generic:v1.14.4
docker tag quay.io/cilium/operator-generic:v1.14.4 ${REGISTRY_URL}/cilium/operator-generic:v1.14.4
docker push ${REGISTRY_URL}/cilium/operator-generic:v1.14.4
...
docker pull quay.io/cilium/hubble-relay:v1.14.4
docker tag quay.io/cilium/hubble-relay:v1.14.4 ${REGISTRY_URL}/cilium/hubble-relay:v1.14.4
docker push ${REGISTRY_URL}/cilium/hubble-relay:v1.14.4
