...
docker pull docker.io/flannel/flannel:v0.25.3
docker tag docker.io/flannel/flannel:v0.25.3 ${REGISTRY_URL}/flannel/flannel:v0.25.3
docker push ${REGISTRY_URL}/flannel/flannel:v0.25.3
