...
docker tag docker.io/calico/cni:v3.29.1 ${REGISTRY_URL}/calico/cni:v3.29.1
docker push ${REGISTRY_URL}/calico/cni:v3.29.1

docker pull docker.io/calico/node:v3.29.1
docker tag docker.io/calico/node:v3.29.1 ${REGISTRY_URL}/calico/node:v3.29.1
docker push ${REGISTRY_URL}/calico/node:v3.29.1

docker pull docker.io/calico/kube-controllers:v3.29.1
docker tag docker.io/calico/kube-controllers:v3.29.1 ${REGISTRY_URL}/calico/kube-controllers:v3.29.1
docker push ${REGISTRY_URL}/calico/kube-controllers:v3.29.1
...
# antrea
docker pull antrea/antrea-agent-ubuntu:v2.2.0
docker tag antrea/antrea-agent-ubuntu:v2.2.0 ${REGISTRY_URL}/antrea/antrea-agent-ubuntu:v2.2.0
docker push ${REGISTRY_URL}/antrea/antrea-agent-ubuntu:v2.2.0

docker pull antrea/antrea-controller-ubuntu:v2.2.0
docker tag antrea/antrea-controller-ubuntu:v2.2.0 ${REGISTRY_URL}/antrea/antrea-controller-ubuntu:v2.2.0
docker push ${REGISTRY_URL}/antrea/antrea-controller-ubuntu:v2.2.0
