...
# calico
docker pull docker.io/calico/cni:v3.31.0
docker tag docker.io/calico/cni:v3.31.0 ${REGISTRY_URL}/calico/cni:v3.31.0
docker push ${REGISTRY_URL}/calico/cni:v3.31.0

docker pull docker.io/calico/node:v3.31.0
docker tag docker.io/calico/node:v3.31.0 ${REGISTRY_URL}/calico/node:v3.31.0
docker push ${REGISTRY_URL}/calico/node:v3.31.0

docker pull docker.io/calico/kube-controllers:v3.31.0
docker tag docker.io/calico/kube-controllers:v3.31.0 ${REGISTRY_URL}/calico/kube-controllers:v3.31.0
docker push ${REGISTRY_URL}/calico/kube-controllers:v3.31.0
