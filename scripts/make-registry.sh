...
docker pull docker.io/flannel/flannel:v0.25.2
docker tag docker.io/flannel/flannel:v0.25.2 ${REGISTRY_URL}/flannel/flannel:v0.25.2
docker push ${REGISTRY_URL}/flannel/flannel:v0.25.2
...
docker tag quay.io/cilium/cilium:v1.15.5 ${REGISTRY_URL}/cilium/cilium:v1.15.5
docker push ${REGISTRY_URL}/cilium/cilium:v1.15.5

docker pull quay.io/cilium/operator-generic:v1.15.5
docker tag quay.io/cilium/operator-generic:v1.15.5 ${REGISTRY_URL}/cilium/operator-generic:v1.15.5
docker push ${REGISTRY_URL}/cilium/operator-generic:v1.15.5
...
docker pull quay.io/cilium/hubble-relay:v1.15.5
docker tag quay.io/cilium/hubble-relay:v1.15.5 ${REGISTRY_URL}/cilium/hubble-relay:v1.15.5
docker push ${REGISTRY_URL}/cilium/hubble-relay:v1.15.5
