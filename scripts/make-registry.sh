...
docker tag docker.io/calico/cni:v3.30.2 ${REGISTRY_URL}/calico/cni:v3.30.2
docker push ${REGISTRY_URL}/calico/cni:v3.30.2

docker pull docker.io/calico/node:v3.30.2
docker tag docker.io/calico/node:v3.30.2 ${REGISTRY_URL}/calico/node:v3.30.2
docker push ${REGISTRY_URL}/calico/node:v3.30.2

docker pull docker.io/calico/kube-controllers:v3.30.2
docker tag docker.io/calico/kube-controllers:v3.30.2 ${REGISTRY_URL}/calico/kube-controllers:v3.30.2
docker push ${REGISTRY_URL}/calico/kube-controllers:v3.30.2
...
docker tag registry.k8s.io/coredns/coredns:v1.12.0 ${REGISTRY_URL}/coredns/coredns:v1.12.0
docker push ${REGISTRY_URL}/coredns/coredns:v1.12.0
...
docker pull ghcr.io/flannel-io/flannel:v0.27.0
docker tag ghcr.io/flannel-io/flannel:v0.27.0 ${REGISTRY_URL}/flannel-io/flannel:v0.27.0
docker push ${REGISTRY_URL}/flannel-io/flannel:v0.27.0


# metrics-server
docker pull registry.k8s.io/metrics-server/metrics-server:v0.8.0
docker tag registry.k8s.io/metrics-server/metrics-server:v0.8.0 ${REGISTRY_URL}/metrics-server/metrics-server:v0.8.0
docker push ${REGISTRY_URL}/metrics-server/metrics-server:v0.8.0
...
# antrea
docker pull antrea/antrea-agent-ubuntu:v2.3.1
docker tag antrea/antrea-agent-ubuntu:v2.3.1 ${REGISTRY_URL}/antrea/antrea-agent-ubuntu:v2.3.1
docker push ${REGISTRY_URL}/antrea/antrea-agent-ubuntu:v2.3.1

docker pull antrea/antrea-controller-ubuntu:v2.3.1
docker tag antrea/antrea-controller-ubuntu:v2.3.1 ${REGISTRY_URL}/antrea/antrea-controller-ubuntu:v2.3.1
docker push ${REGISTRY_URL}/antrea/antrea-controller-ubuntu:v2.3.1
