...
# calico
docker pull docker.io/calico/cni:v3.29.3
docker tag docker.io/calico/cni:v3.29.3 ${REGISTRY_URL}/calico/cni:v3.29.3
docker push ${REGISTRY_URL}/calico/cni:v3.29.3

docker pull docker.io/calico/node:v3.29.3
docker tag docker.io/calico/node:v3.29.3 ${REGISTRY_URL}/calico/node:v3.29.3
docker push ${REGISTRY_URL}/calico/node:v3.29.3

docker pull docker.io/calico/kube-controllers:v3.29.3
docker tag docker.io/calico/kube-controllers:v3.29.3 ${REGISTRY_URL}/calico/kube-controllers:v3.29.3
docker push ${REGISTRY_URL}/calico/kube-controllers:v3.29.3
