...
docker tag antrea/antrea-agent-ubuntu:v2.4.0 ${REGISTRY_URL}/antrea/antrea-agent-ubuntu:v2.4.0
docker push ${REGISTRY_URL}/antrea/antrea-agent-ubuntu:v2.4.0

docker pull antrea/antrea-controller-ubuntu:v2.4.0
docker tag antrea/antrea-controller-ubuntu:v2.4.0 ${REGISTRY_URL}/antrea/antrea-controller-ubuntu:v2.4.0
docker push ${REGISTRY_URL}/antrea/antrea-controller-ubuntu:v2.4.0
